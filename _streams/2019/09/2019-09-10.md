...
description: "Cleaning up the UI on a client front-end with MVC, CSS & HTML"
comments: true
tags: [twitch, stream, aspnet, jquery, css, html]
...
| Timestamp | Topic
| ---       | ---
| [00:08]({{page.replay}}?t=507.296)    | Kicking it off |
| [00:32]({{page.replay}}?t=1920)       | Discussing project and starting to build out UI   |
| [03:52]({{page.replay}}?t=13955.827)  | Wrapping up and raid to [roberttables](https://twitch.tv/roberttables) |
...
<div class="users">
  <div class="user">
    ...
    <span>SushiDay<br/>
      <a href="https://twitch.tv/sushiday" target="_blank"><i class="fab fa-twitch" aria-hidden="true"></i></a>
  </div>
  <div class="user">
  ...
  <div class="user">
    ...
    <span>ChanceDev<br/>
      <a href="https://twitch.tv/chancedev" target="_blank"><i class="fab fa-twitch" aria-hidden="true"></i></a>
  </div>
  <div class="user">
...
<div class="users">
  <div class="user">
    ...
    <span>jlengstorf<br/>
      <a href="https://twitch.tv/jlengstorf" target="_blank"><i class="fab fa-twitch" aria-hidden="true"></i></a>
  </div>
  <div class="user">
...
<div class="users">
  ...
  <div class="user">
    ...
    <span>AccordingToBo<br/>
      <a href="https://twitch.tv/accordingtobo" target="_blank"><i class="fab fa-twitch" aria-hidden="true"></i></a>
  </div>
  <div class="user">
  ...
  <div class="user">
    <img class="profile" src="https://static-cdn.jtvnw.net/user-default-pictures/0ecbb6c3-fecb-4016-8115-aa467b7c36ed-profile_image-300x300.jpg"/>
    <span>deathstombstone666<br/>
      <a href="https://twitch.tv/deathstombstone666" target="_blank"><i class="fab fa-twitch" aria-hidden="true"></i></a>
  </div>
  <div class="user">
  ...
  <div class="user">
    ...
    <span>Eolios<br/>
      <a href="https://twitch.tv/eolios" target="_blank"><i class="fab fa-twitch" aria-hidden="true"></i></a>
  </div>
  <div class="user">
    <img class="profile" src="https://static-cdn.jtvnw.net/jtv_user_pictures/tehstormcrow-profile_image-79e5d2daf440f5c7-300x300.jpeg"/>
    <span>tehstormcrow<br/>
      <a href="https://twitch.tv/tehstormcrow" target="_blank"><i class="fab fa-twitch" aria-hidden="true"></i></a>
  </div>
  <div class="user">
    ...
    <span>GOmonkeymanGO<br/>
      <a href="https://twitch.tv/gomonkeymango" target="_blank"><i class="fab fa-twitch" aria-hidden="true"></i></a>
  </div>
  <div class="user">
  ...
  <div class="user">
    ...
    <span>mrBalrog<br/>
      <a href="https://twitch.tv/mrbalrog" target="_blank"><i class="fab fa-twitch" aria-hidden="true"></i></a>
  </div>
  <div class="user">
    ...
    <span>zeldakenobi<br/>
      <a href="https://twitch.tv/zeldakenobi" target="_blank"><i class="fab fa-twitch" aria-hidden="true"></i></a>
  </div>
  <div class="user">
    <img class="profile" src="https://static-cdn.jtvnw.net/user-default-pictures/0ecbb6c3-fecb-4016-8115-aa467b7c36ed-profile_image-300x300.jpg"/>
    <span>ligtgaard<br/>
      <a href="https://twitch.tv/ligtgaard" target="_blank"><i class="fab fa-twitch" aria-hidden="true"></i></a>
  </div>
  <div class="user">
  ...
  <div class="user">
    ...
    <span>alanchristopherturing<br/>
      <a href="https://twitch.tv/alanchristopherturing" target="_blank"><i class="fab fa-twitch" aria-hidden="true"></i></a>
  </div>
  <div class="user">
    ...
    <span>Cyber3x<br/>
      <a href="https://twitch.tv/cyber3x" target="_blank"><i class="fab fa-twitch" aria-hidden="true"></i></a>
  </div>
  <div class="user">
    ...
    <span>WraithGaming<br/>
      <a href="https://twitch.tv/wraithgaming" target="_blank"><i class="fab fa-twitch" aria-hidden="true"></i></a>
  </div>
  <div class="user">
    <img class="profile" src="https://static-cdn.jtvnw.net/user-default-pictures/49988c7b-57bc-4dee-bd4f-6df4ad215d3a-profile_image-300x300.jpg"/>
    <span>michmood<br/>
      <a href="https://twitch.tv/michmood" target="_blank"><i class="fab fa-twitch" aria-hidden="true"></i></a>
  </div>
  <div class="user">
  ...
  <div class="user">
    ...
    <span>cmgriffing<br/>
      <a href="https://twitch.tv/cmgriffing" target="_blank"><i class="fab fa-twitch" aria-hidden="true"></i></a>
  </div>
  <div class="user">
